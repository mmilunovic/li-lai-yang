...
public class TransactionMessage extends BasicMessage {
	...
	public TransactionMessage(ServentInfo sender, ServentInfo receiver, int amount, BitcakeManager bitcakeManager, int collectorId) {
		super(MessageType.TRANSACTION, sender, receiver, String.valueOf(amount), AppConfig.initiatorsVersion);
